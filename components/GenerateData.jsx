        ...
        <div className="flex flex-row items-start justify-center min-h-screen bg-white mt-20">
            <div className="relative flex flex-col md:flex-row min-w-0 break-words bg-white shadow-xl border-white p-7 drop-shadow-md rounded-2xl mr-10">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="mt-2">
                        <strong>Baris Kebun:</strong>{" "}
                        {data.selectedRowCount} Baris
                    </p>
                    <p className="mt-2">
                    ...
                    <p className="mt-2">
                        <strong>Status Pompa Air:</strong>{" "}
                        {data.autoWater ? "Menyiram" : "Tidak Menyiram"}
                    </p>
                    {data.autoWater && (
                        <p className="font-bold mt-2">
                            Penyiraman otomatis akan menyala setiap{" "}
                            {data.wateringInterval} jam sekali.
                        </p>
                    )}
                    </div>
            </div>
